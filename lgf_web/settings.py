"""
Django settings for lgf_web project.
...
ALLOWED_HOSTS = ['13.48.130.71','learnersgirlsfoundation.org','127.0.0.1']
...
WSGI_APPLICATION = 'lgf_web.wsgi.application'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = '/home/ubuntu/lgf_web/media/'
